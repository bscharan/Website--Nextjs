...
export default function FirstPost() {
    return (
        <div>
            <Head>
                <title>Ideapad - Privacy Policy</title>
            </Head>
                    ...
                    <div className='border-b-4 border-t-2 border-dotted border-ts_red py-2 my-2'>
                        <div className="">
                            <Image className='mx-auto shadow rounded'
                                src="/Ideapad/Ideapad_Banner.png"
                                width={500}
                                height={500}
                                alt="Ideapad Android Application banner"
                            />
                        </div>
                    </div>
...
function PrivacyPolicy() {
    return (
        < div className='p-4 m-4'>
            < strong className='text-ts_red' > Privacy Policy for Using Ideapad </ strong>
            <p className='px-4 mx-4'>
                bscharan built the Ideapad app as a Free app. This SERVICE is provided by bscharan at no cost and is intended for use as is.
            </p>
            <p className='px-4 mx-4' >
            ...
            <p className='px-4 mx-4' >
                The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Ideapad unless otherwise defined in this Privacy Policy.
            </p>
            ...
            <p className='px-4 mx-4' >This policy is effective as of 2025-07-21
                <ul className='list-disc px-4 mx-4'>
                    <li>2025-07-21 : Created</li>
                </ul>
            </p>
