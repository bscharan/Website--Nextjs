    ...
    <div>
      ...
      <main className="bg-white text-slate-600 italic bg-cover min-h-screen text-center py-3">
        <section className="bg-white bg-opacity-30 text-slate-600 shadow-2xl rounded-lg mx-2 sm:mx-6 md:mx-24 lg:mx-48 ">
          <div className="border-b-4 border-dotted border-ts_red py-2 my-2">
            <Intro></Intro>
            <div className=" flex justify-center text-ts_red my-4 gap-2">
          ...
          <div className='border-b-4 border-dotted border-ts_red py-2 my-2'>
            ...
            <h3>
              There is no enough time to make all the things i want the <Link className='text-ts_red' href='/myspace/others/future_todo'>
...
function Intro() {
  ...
  return (
    <>
      ...
      <h3>
        I am an
        {showText ? <span className='text-ts_red'> Engineer </span> : (
